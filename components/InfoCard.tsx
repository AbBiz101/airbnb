...
export default function InfoCard({
	...
	return (
		<div className="flex py-7 px-2 border-b cursor-pointer hover:opacity-80 hover:shadow-lg transition duration-200 rase-out first:border-t">
			...
			<div className="flex flex-col flex-grow pl-5">
				...
				<h4 className="border-b w-10 pt-2" />
